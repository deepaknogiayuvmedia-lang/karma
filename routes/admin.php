...
use App\Http\Controllers\Admin\ProductQueryController;
use App\Http\Controllers\Admin\ChanalController;
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        //prdouct-query
             Route::group(['prefix' => 'prdouct-query'], function () {
            Route::get('list', [ProductQueryController::class ,'list'])->name('pqlist');
            Route::post('asign-product', [SaleManagerController::class ,'asign_product'])->name('asign-product');
            Route::post('asign-expressbee','OrderController@addexpressdelevry')->name('asign-expressbee');
        ...
        Route::group(['prefix' => 'sale', 'as' => 'sale.employee.','middleware'=>['module:user_section']], function () {
            Route::get('add-new', [SaleManagerController::class,'add_new'])->name('emp-add-new');
            Route::post('add-new', [SaleManagerController::class,'store'])->name('emp-store');
            Route::get('list', [SaleManagerController::class,'list'])->name('emp-list');
            Route::get('update/{id}', [SaleManagerController::class,'edit'])->name('emp-update');
            Route::post('update/{id}', [SaleManagerController::class,'update']);
            Route::post('status', [SaleManagerController::class,'status'])->name('emp-status');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['middleware'=>['module:system_settings']],function(){
                ...
                // chanal
                Route::get('chanal', [ChanalController::class,'chanal'])->name('chanal');
                Route::get('chanal-fetch', [ChanalController::class,'fetch'])->name('chanal-fetch');
                Route::post('chanal-store', [ChanalController::class,'chanal_store'])->name('chanal-store');
                Route::post('chanal-edit', [ChanalController::class,'chanal_edit'])->name('chanal-edit');
                Route::post('chanal-update', [ChanalController::class,'chanal_update'])->name('chanal-update');
                Route::post('chanal-delete', [ChanalController::class,'chanal_delete'])->name('chanal-delete');
                Route::post('chanal-status-update', [ChanalController::class,'chanal_status_update'])->name('chanal-status-update');
