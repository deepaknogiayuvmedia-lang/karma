...
Route::get('/clear', function () {
    ...
    return redirect()->back()->with('massage', 'Cleared Successfully');
});

//for maintenance mode
Route::get('maintenance-mode', 'Web\WebController@maintenance_mode')->name('maintenance-mode');

Route::post('product-query', [WebController::class, 'product_query'])->name('product-query');
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode']], function () {
    ...
    Route::get('cancellation-policy', 'WebController@cancellation_policy')->name('cancellation-policy');
        Route::get('shipping-policy', 'WebController@shipping_policy')
...
Route::get('sugo-plus', 'SugoPlusController@index')->name('sugo-plus');
Route::get('StaminXP-1Packs', 'SugoPlusController@stamin')->name('stamin');
Route::get('ketoplus', 'SugoPlusController@ketoplus')->name('ketoplus');
Route::get('/{product}/thankyou', 'SugoPlusController@thankyoupage')->name('thankyoupage');
