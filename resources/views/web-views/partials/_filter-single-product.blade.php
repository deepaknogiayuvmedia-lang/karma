...
<div class="product-single-hover">
    <div class="overflow-hidden position-relative ">
        <div class="inline_product clickable rtl " style="background:#fff;border-radius: 5px 5px 0px 0px;">
        ...
        <div class="single-product-details pb-3 d-flex flex-column justify-content-between">
            <div>
            ...
            <div class="text-center d-flex justify-content-between align-items-center px-2 quick-view1">
                ...
                @else
                    ...
                    <a class="border rounded-2 btn-sm d-flex justify-content-between align-items-center gap-4 w-75"
                        ...
                        <i
                            class="czi-arrow-down align-middle {{ Session::get('direction') === 'rtl' ? 'ml-1' : 'mr-1' }}"></i>
                    </a>
                @endif
            </div>
        </div>
