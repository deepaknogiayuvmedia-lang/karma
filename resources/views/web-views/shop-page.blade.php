...
@push('css_or_js')
    @if($shop['id'] != 0)
        <meta property="og:image" content="{{asset(config('app.public_storage_path').'shop')}}/{{$shop->image}}"/>
        <meta property="og:title" content="{{ $shop->name}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="og:image" content="{{asset(config('app.public_storage_path').'company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="og:title" content="{{ $shop['name']}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
    ...
    @if($shop['id'] != 0)
        <meta property="twitter:card" content="{{asset(config('app.public_storage_path').'shop')}}/{{$shop->image}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="twitter:card"
              content="{{asset(config('app.public_storage_path').'company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="twitter:title" content="{{route('shopView',[$shop['id']])}}"/>
        <meta property="twitter:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
            ...
            <div class="col-lg-12 mt-2">
                <div class="bg-white">
                    ...
                    @else
                        ...
                        <img class="__shop-page-banner"
                             src="{{asset(config('app.public_storage_path')."/shop")}}/{{$banner??""}}"
                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                             alt="">
                    @endif
                </div>
                            ...
                            <div class="">
                                ...
                                @else
                                    <div class="position-relative">
                                        ...
                                        @endif
                                        <img class="__inline-68"
                                             src="{{asset(config('app.public_storage_path').'/company')}}/{{$web_config['fav_icon']->value}}"
                                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                             alt="">
                                    </div>
                                @endif
