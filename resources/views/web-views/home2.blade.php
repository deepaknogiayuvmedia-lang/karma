...
@section('content')
    <div class="mobile-sticky-category owl-carousel" id="mobile-category-slider">
    ...
    $flash_deals = \App\Model\FlashDeal::with([
        ...
        {{-- categries --}}
        <div class="container rtl d-none d-md-block">
            <div class="row">
                            ...
                            <div class="deal_of_the_day h-100" style="background: {{ $web_config['primary_color'] }}">
                                @if (isset($deal_of_the_day) && isset($deal_of_the_day->product))
                                    <div class="d-flex justify-content-center align-items-center __w-70p mx-auto">
                                        <h1 class="align-items-center text-white">
                                                    ...
                                                    <div class="rating-show">
                                                        ...
                                                        <span class="d-inline-block font-size-sm text-body">
                                                            @for ($inc = 0; $inc < 5; $inc++)
                                                                ...
                                                                @endif
                                                            @endfor
                                                            <label class="badge-style">( {{ $product->reviews_count }}
                                                                )</label>
                                                        </span>
                                                    </div>
