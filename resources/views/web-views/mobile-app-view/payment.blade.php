                                        ...
                                        <div class="card-body __h-100px">
                                            ...
                                            <!-- Note that the amount is in paise = 50 INR -->
                                                ...
                                                <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                        ...
                                                        data-description=""
                                                        data-image="{{asset(env('PUBLIC_STORAGE_PATH').'/company/'.\App\Model\BusinessSetting::where(['type'=>'company_web_logo'])->first()->value)}}"
                                    ...
                                    <div class="card cursor-pointer">
                                        <div class="card-body __h-100px">
                                            <a class="btn btn-block click-if-alone" href="{{route('phonepe-payment')}}">
                                                <img class="__inline-55" src="{{asset('public/assets/front-end/img/phonepe-1.svg')}}"/>
                                            </a>
                                        </div>
                                    </div>
                                </div>
