        ...
        <div class="row gap-4">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ $shop->wherehouse ? route('seller.shop.address-update', [$shop->id]) : route('seller.shop.save-address', [$shop->id]) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="whatsapp_number" class="form-control"
                                            placeholder="91XXXXXXXXXX" value="{{ $shop->whatsapp_no ?? '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gst_number" class="form-control"
                                            placeholder="22AAAAA0000A1Z5" value="{{ $shop->gst_no ?? '' }}">
                                    </div>
                                </div>
                                {{-- GST Certificate PDF --}}
                                <div class="col-md-4">
                                    ...
                                    <label class="title-color">
                                        ...
                                        <div class="custom-file text-left">
                                            <input type="file" name="gst_certificate" id="gstCertificateUpload"
                                                class="custom-file-input" accept=".pdf">
                                            <label class="custom-file-label"
                                                for="gstCertificateUpload">{{ \App\CPU\translate('choose') }}
                                                {{ \App\CPU\translate('file') }}</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pan_number" class="form-control"
                                            placeholder="ABCDE1234F" value="{{ $shop->pen_no ?? '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <label class="
                                        ...
                                        <div class="custom-file text-left">
                                            <input type="file" name="pan_card" id="panCardUpload"
                                                class="custom-file-input" accept=".pdf">
                                            <label class="custom-file-label"
                                                for="panCardUpload">{{ \App\CPU\translate('choose') }}
                                                {{ \App\CPU\translate('file') }}</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                        class="title-color">{{ \App\CPU\translate('PIN Code') }}</label>
                                                    <input type="text" name="business_pincode"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="business_country"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="border-bottom  mb-3 d-flex justify-content-between">
                                                    <h5 class=" text-capitalize">
                                                        {{ \App\CPU\translate('Warehouse Address') }}</h5>
                                                    <div class=""> <input class="form-check-input" type="checkbox"
                                                            id="sameAddressCheckbox">
                                                        <label class="form-check-label title-color fw-normal"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="warehouse_address_line1"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="title-color">{{ \App\CPU\translate('State') }}</label>
                                                    <input type="text" name="warehouse_state"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                        class="title-color">{{ \App\CPU\translate('PIN Code') }}</label>
                                                    <input type="text" name="warehouse_pincode"
                                                        placeholder="Enter Pin Code" class="form-control"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="title-color">{{ \App\CPU\translate('Country') }}</label>
                                                    <input type="text" name="warehouse_country"
                                                        placeholder="Enter Country" class="form-control"
