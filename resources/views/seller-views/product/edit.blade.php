                ...
                <form class="product-form" action="{{ route('seller.product.update', $product->id) }}" method="post"
                    ...
                    <div class="card">
                        ...
                        <div class="">
                            ...
                            <ul class="nav nav-tabs w-fit-content ">
                            ...
                            @else
                                ...
                                <div class="lang_form" id="en-form">
                                     <div class="row">
                                         <div class="col-md-4 form-group">
                                             ...
                                             <input type="text" name="name[]"
                                                 id="en_name"
                                                 value="{{ $translate['en']['name'] ?? $product['name'] }}"
                                                 class="form-control" placeholder="New Product" required>
                                         </div>
                                         <div class="col-md-4 form-group">
                                             <label class="title-color"
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <div style="position:relative;">
                                            <textarea name="description[]" class=" w-100 tiny-editor" rows="10" required>{!! $translate['en']['description'] ?? $product['details'] !!}</textarea>
                                            <div id="editor-loading" class="text-center border rounded" style="display:none; position:absolute; top:0; left:0; right:0; bottom:0; z-index:10; background:#fff; align-items:center; justify-content:center; flex-direction:column;">
                                                <div class="spinner-border text-primary" role="status">
                                                    <span class="sr-only">Loading...</span>
                                                </div>
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4 class="mb-0">{{ \App\CPU\translate('Product price & stock') }}</h4>
                              @if ($product['indexing'] != 1 && $product['lowest_market_price'] > $product['actual_amount'])
                                    <div style="color: red;" class="hratebit">
                                        {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($product->suggested_price)) . '-' . \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($product->lowest_market_price)) }}
                                    </div>
                                @endif
                        </div>
                        <div class="card-body">
