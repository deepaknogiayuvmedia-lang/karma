                        ...
                        <div class="media align-items-center px-3 gap-3 mb-4">
                            <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img"
                                    ...
                                    src="{{ asset(config('app.public_storage_path') . '/seller/') }}/{{ auth('seller')->user()->image }}"
                                        ...
                                        <div class="chat_list p-3 d-flex gap-2 user_{{ $chatting->user_id ? $chatting->user_id : $chatting->delivery_man_id }} seller-list @if ($key == 0) active @endif"
                                            ...
                                            <div class="chat_people media gap-10" id="chat_people">
                                                <div class="chat_img avatar avatar-sm avatar-circle">
                                                    <img @if (Request::is('seller/messages/chat/customer')) src="{{ asset(config('app.public_storage_path') . '/profile/' . $chatting->image) }}"
                                                        @else
                                                            src="{{ asset(config('app.public_storage_path') . '/delivery-man/' . $chatting->image) }}" @endif
                                                        id="{{ $chatting->user_id ? $chatting->user_id : $chatting->delivery_man_id }}"
                                                        onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                            ...
                            <div class="media align-items-center gap-3">
                                <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" id="profile_image"
                                        @if (Request::is('seller/messages/chat/customer')) src="{{ asset(config('app.public_storage_path') . '/profile/' . $chattings_user[0]->image) }}"
                                         @else
                                         src="{{ asset(config('app.public_storage_path') . '/delivery-man/' . $chattings_user[0]->image) }}" @endif
                                        onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                        alt="Image Description">
                                    <span class="avatar-status avatar-sm-status avatar-status-success"></span>
                                </div>
