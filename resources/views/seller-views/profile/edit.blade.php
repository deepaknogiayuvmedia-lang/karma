...
@section('content')
    ...
    <div class="content container-fluid">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        @if ($seller->status === 'approved')
                            ...
                            <span
                                class="text-muted">{{ \App\CPU\translate('Your vendor account is verified and active') }}</span>
        ...
        <div class="row">
            <div class="col-lg-3 ">
                <!-- Navbar -->
                <div class="navbar-vertical navbar-expand-lg mb-3 mb-lg-5 position-sticky" style="top:80px;">
                    <!-- Navbar Toggle -->
                ...
                <form action="{{ route('seller.profile.update', [$data->id]) }}" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <div class="profile-cover">
                            @php($shop_banners = $shop_banner ? asset(config('app.public_storage_path') . '/shop/banner/' . $shop_banner) : 'https://images.pexels.com/photos/866398/pexels-photo-866398.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                            ...
                            <img id="viewer" onerror="this.src='{{ asset('assets/back-end/img/160x160/img1.jpg') }}'"
                                class="avatar-img"
                                src="{{ asset(config('app.public_storage_path') . '/seller') }}/{{ $data->image }}"
                                alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-form-label">
                                    <label class="col-form-label input-label""
                                        for=" customFileUpload">{{ \App\CPU\translate('image') }}</label>
                                </div>
