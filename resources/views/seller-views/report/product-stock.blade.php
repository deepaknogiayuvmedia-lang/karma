                    ...
                    <div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a class="dropdown-item"
                                    href="{{ route('seller.report.product-stock-export', ['category_id' => request('category_id'), 'sort' => request('sort'), 'search' => request('search')]) }}">{{ \App\CPU\translate('excel') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($products as $key => $data)
                                <tr>
                                    ...
                                    <td>{{ date('d M Y', $data['updated_at'] ? strtotime($data['updated_at']) : null) }}
                                    </td>
