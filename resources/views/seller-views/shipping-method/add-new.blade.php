                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 mt-2" id="product_wise_note" style="display: none">
                                <p class="m-2" class="text-danger">{{ \App\CPU\translate('note') }}:
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title" class="form-control"
                                        placeholder="Ex: Name of Shipping Category">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" min="0" max="1000000" step="0.01" name="cost"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switcher mx-auto">
                                            <input type="checkbox" class="status switcher_input" id="{{ $method['id'] }}"
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            ...
                                            <a class="btn btn-outline-danger btn-sm delete"
                                                title="{{ \App\CPU\translate('Delete') }}" id="{{ $method['id'] }}">
        ...
        <div class="card mt-2" id="update_category_shipping_cost">
            ...
            <div class="table-responsive">
                <table
                    ...
                    <tbody>
                        <form action="{{ route('seller.business-settings.category-shipping-cost.store') }}"
                            method="POST">
                            @csrf
