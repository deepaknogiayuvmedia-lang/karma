                    ...
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            <img class="avatar avatar-xxl avatar-4by3 mr-4"
                                 ...
                                 src="{{asset(config('app.public_storage_path').'/delivery-man')}}/{{$dm['image']}}"
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach(json_decode($review['attachment'],true) as $attachment)
                                    <img width="100" onerror="this.src='{{asset('assets/admin/img/160x160/img2.jpg')}}'" src="{{asset(config('app.public_storage_path').'/review')}}/{{$attachment}}">
                                @endforeach
                            </td>
                            <td>
