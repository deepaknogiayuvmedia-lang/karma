                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a class="dropdown-item"
                                    href="{{ route('seller.transaction.expense-transaction-export-excel', ['date_type' => request('date_type'), 'from' => request('from'), 'to' => request('to'), 'search' => request('search')]) }}">{{ \App\CPU\translate('Excel') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($expense_transactions_table as $key => $transaction)
                                <tr>
                                    ...
                                    <td>{{ date_format($transaction->order_transaction->updated_at, 'd F Y, h:i:s a') }}
                                    </td>
                                    <td>
                                        <a class="title-color"
