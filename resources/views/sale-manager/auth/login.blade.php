...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CPU\translate('Sale Manager | Login')}}</title>
...
<main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2" height="40" src="{{asset(env('PUBLIC_STORAGE_PATH').'/company/'.$e_commerce_logo)}}" alt="Logo"
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <!-- Form -->
                        <form id="form-id" action="{{route('sale.auth.login')}}" method="post">
                            @csrf

                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4">{{\App\CPU\translate('sign_in')}}</h1><br>
                                    <span>({{\App\CPU\translate('Sale Manager Login')}})</span>
                                </div>
                            </div>
