...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <img  onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{asset(env('PUBLIC_STORAGE_PATH').'/app/public/admin/'.$data->image)}}" class="rounded-circle border"
