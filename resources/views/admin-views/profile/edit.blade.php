    ...
    <div class="content container-fluid">
        ...
        <div class="row">
                ...
                <div class="navbar-vertical navbar-expand-lg mb-3 mb-lg-5">
                    ...
                    <div id="navbarVerticalNavMenu" class="collapse navbar-collapse">
                        ...
                        <ul id="navbarSettings"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:" id="wherehouseSection">
                                    <i class="tio-shop-outlined nav-icon"></i> {{ \App\CPU\translate('Wherehouse') }}
                                </a>
                            </li>
                        </ul>
                        <!-- End Navbar Nav -->
            ...
            <div class="col-lg-9">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label">
                                    ...
                                    <i class="tio-help-outlined text-body ml-1" title="Display name"></i>
                                </label>
                ...
                <div id="wherehouseDiv" class="card mb-3 mb-lg-5">
                    <!-- Card -->
                    <div class="card-header">
                        <h4 class="card-title">{{ \App\CPU\translate('Wherehouse') }}</h4>
                    </div>
                    <!-- End Card Header -->
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="wherehouseForm" action="{{ route('admin.profile.whereHouse') }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            @php($wherehouse = $data->wherehouse)
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="address_line1" class="col-sm-3 col-form-label input-label">
                                    {{ \App\CPU\translate('Address Line 1') }}</label>
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="city" class="col-sm-3 col-form-label input-label">
                                    {{ \App\CPU\translate('City') }}</label>
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="state" class="col-sm-3 col-form-label input-label">
                                    {{ \App\CPU\translate('State') }}</label>
                            ...
                            <!-- Form Group -->
                            <div class="row form-group">
                                <label for="pincode" class="col-sm-3 col-form-label input-label">
                                    {{ \App\CPU\translate('Pincode') }}</label>

                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="pincode" id="pincode"
                                        placeholder="{{ \App\CPU\translate('Enter pincode') }}"
                                        aria-label="Enter pincode" value="{{ $wherehouse['pincode'] ?? '' }}">
                                </div>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                    onclick="{{ env('APP_MODE') != 'demo' ? "form_alert('wherehouseForm','Want to update wherehouse info ?')" : 'call_demo()' }}"
                                    class="btn btn--primary">{{ \App\CPU\translate('Save') }}
                                    {{ \App\CPU\translate('changes') }}</button>
                            </div>
                        </form>
...
@push('script_2')
    ...
    <script>
        ...
        $("#passwordSection").click(function() {
            ...
            $("#wherehouseSection").removeClass("active");
        ...
        $("#wherehouseSection").click(function() {
            $("#generalSection").removeClass("active");
            $("#passwordSection").removeClass("active");
            $("#wherehouseSection").addClass("active");
            $('html, body').animate({
                scrollTop: $("#wherehouseDiv").offset().top
            }, 2000);
        });
    </script>
@endpush
