...
@section('title', \App\CPU\translate('Sale Employee List'))
@push('css_or_js')
...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            ...
            {{\App\CPU\translate('sale_employee_list')}}
        </h2>
    </div>
    <!-- End Page Title -->
            ...
            <div class="card">
                <div class="card-header flex-wrap gap-10">
                    <h5 class="mb-0 d-flex gap-2 align-items-center">
                        {{\App\CPU\translate('Sale employee table')}}
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{route('admin.sale.employee.emp-add-new')}}" class="btn btn--primary">
                            <i class="tio-add"></i>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label class="switcher">
                                        <input type="checkbox" class="status switcher_input"" id="{{$e['id']}}"
                                            {{$e->status?'checked':''}}>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a href="{{route('admin.sale.employee.emp-update',[$e['id']])}}"
