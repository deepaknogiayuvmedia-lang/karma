        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.sale.employee.emp-update', [$e['id']]) }}" method="post"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="number" value="{{ $e['mobile'] }}" required name="phone"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="text-center">
                                            <img class="upload-img-view" id="viewer"
                                                ...
                                                src="{{ asset(config('app.public_storage_path') . '/admin') }}/{{ $e['photo'] }}"
