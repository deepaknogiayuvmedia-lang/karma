    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.sale.employee.emp-update',[$e['id']])}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" value="{{$e['mobile']}}" required name="phone" class="form-control" id="phone"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="text-center">
                                        ...
                                        src="{{asset(config('app.public_storage_path').'/admin')}}/{{$e['photo']}}" alt="Employee thumbnail"/>
                                    </div>
                                </div>
                            </div>
                        </div>
