...
@section('title', \App\CPU\translate('Sale Employee Add'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\translate('Add_New_Sale_Employee')}}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('admin.sale.employee.emp-store')}}" method="post" enctype="multipart/form-data"
