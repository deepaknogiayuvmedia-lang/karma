...
@section('title', \App\CPU\translate('Product Change Requests'))
    ...
    <div class="content container-fluid">
        <div class="mb-4">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{ \App\CPU\translate('Product Change Requests') }}
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.product.change-requests') }}" method="GET">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-10">
                                                <a class="btn btn-info btn-sm" href="{{ route('admin.product.view-change-request', [$req->id]) }}">
                                                        ...
                                                        <form action="{{ route('admin.product.approve-change-request') }}" method="POST">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">{{ \App\CPU\translate('Approve Change Request') }}</h5>
                                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-info">
                                                                        {{ \App\CPU\translate('This will apply all changes to the product.') }}
                                                                    </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-success">{{ \App\CPU\translate('Approve & Apply') }}</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="rejectModal{{ $req->id }}" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog" role="document">
                                                        <form action="{{ route('admin.product.reject-change-request') }}" method="POST">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">{{ \App\CPU\translate('Reject Change Request') }}</h5>
                                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="form-group">
