                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.membership-plan.store') }}" method="POST">
                                ...
                                <div class="col-md-6 col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="{{ \App\CPU\translate('Ex: Basic') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 col-12">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="duration" class="form-control"
                                                placeholder="{{ \App\CPU\translate('Ex: 1') }}" required>
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                ...
                                <button type="submit"
                                    class="btn btn--primary btn-primary px-4">{{ \App\CPU\translate('submit') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
