                        ...
                        <div class="row g-2 mb-20">
                            <div class="col-sm-6 col-lg-3">
                                ...
                                <a class="order-stats order-stats_pending"
                                    ...
                                    <div class="order-stats__content">
                                        <img width="20" src="{{ asset('/assets/back-end/img/pending.png') }}"
                                            class="svg" alt="">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                <a class="order-stats order-stats_out-for-delivery"
                                    ...
                                    <div class="order-stats__content"
                                        style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                                        <img width="20" src="{{ asset('/assets/back-end/img/out-of-delivery.png') }}"
                                            alt="">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="order-stats order-stats_delivered cursor-pointer"
                                    ...
                                    <div class="order-stats__content"
                                        style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                                        <img width="20" src="{{ asset('/assets/back-end/img/delivered.png') }}"
                                            alt="">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="order-stats order-stats_failed cursor-pointer"
                                    ...
                                    <div class="order-stats__content"
                                        style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};">
                                        <img width="20"
                                            src="{{ asset('/assets/back-end/img/failed-to-deliver.png') }}"
                                            alt="">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li>
                                        <a type="submit" class="dropdown-item d-flex align-items-center gap-2"
                                            href="{{ route('admin.orders.order-bulk-export', ['status' => $status, 'from' => $from, 'to' => $to, 'filter' => $filter, 'search' => $search]) }}">
                                            <img width="14" src="{{ asset('/assets/back-end/img/excel.png') }}"
                                                alt="">
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    <th class=""><input type="checkbox"
                                            id="select_all">{{ \App\CPU\translate('SL') }}/{{ \App\CPU\translate('Order') }}
                                    </th>
                            ...
                            <tbody>
                                @foreach ($orders as $key => $order)
                                    <tr class="status-{{ $order['order_status'] }} class-all">
                                        <td class="">
                                            @if (!$order['third_party_delivery_tracking_id'] && $order['order_status'] == 'confirmed')
                                                <input type="checkbox" id="asign{{ $order['id'] }}" name="asign[]"
