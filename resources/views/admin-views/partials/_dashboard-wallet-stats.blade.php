        ...
        <div class="col-md-6">
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    ...
                    <div>
                        <img width="40" class="mb-2" src="{{ asset('/assets/back-end/img/ce.png') }}"
                            alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    ...
                    <div>
                        <img width="40" class="mb-2" src="{{ asset('/assets/back-end/img/dce.png') }}"
                            alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    ...
                    <div>
                        <img width="40" class="mb-2" src="{{ asset('/assets/back-end/img/ttc.png') }}"
                            alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card card-body h-100 justify-content-center">
                <div class="d-flex gap-2 justify-content-between align-items-center">
                    ...
                    <div>
                        <img width="40" class="mb-2" src="{{ asset('/assets/back-end/img/pa.png') }}"
                            alt="">
                    </div>
                </div>
            </div>
