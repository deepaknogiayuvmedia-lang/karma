...
@section('title', \App\CPU\translate('Seller Score List'))
                    ...
                    <div class="table-responsive">
                        <table style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }};"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    <th>{{ \App\CPU\translate('Rank') }}</th>
                                    <th>{{ \App\CPU\translate('shop_name') }}</th>
                                    <th>{{ \App\CPU\translate('seller_name') }}</th>
                                    <th class="text-center">{{ \App\CPU\translate('Score') }}</th>
                                    <th class="text-center">{{ \App\CPU\translate('total_products') }}</th>
                                    {{-- <th class="text-center">{{\App\CPU\translate('avg_rating')}}</th> --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="font-weight-bold text-primary">
                                                {{ number_format($seller->rank_score, 2) }}
                                            </div>
                                        </td>
                                        <td class="text-center">
