                        ...
                        <div class="card-body"
                            ...
                            <div class="mt-2">
                                <div class="flex-start">
                                    ...
                                    <div class="mx-1">
                                        <h4>{{ $withdraw_request->seller->bank_name ? $withdraw_request->seller->bank_name : 'No Data found' }}
                                        </h4>
                                    </div>
                                </div>
                                <div class="flex-start">
                                    ...
                                    <div class="mx-1">
                                        <h6>{{ $withdraw_request->seller->branch ? $withdraw_request->seller->branch : 'No Data found' }}
                                        </h6>
                                    </div>
                                </div>
                                <div class="flex-start">
                                    ...
                                    <div class="mx-1">
                                        <h6>{{ $withdraw_request->seller->holder_name ? $withdraw_request->seller->holder_name : 'No Data found' }}
                                        </h6>
                                    </div>
                                </div>
                                <div class="flex-start">
                                    ...
                                    <div class="mx-1">
                                        <h6>{{ $withdraw_request->seller->account_no ? $withdraw_request->seller->account_no : 'No Data found' }}
                                        </h6>
                                    </div>
                                </div>
                            </div>
