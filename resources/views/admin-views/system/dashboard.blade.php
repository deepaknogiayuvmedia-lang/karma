...
<div class="content container-fluid">
            ...
            <div class="row flex-between align-items-center g-2 mb-3">
                <div class="col-sm-6">
                    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                        <img src="{{asset('/public/assets/back-end/img/business_analytics.png')}}" alt="">{{\App\CPU\translate('business_analytics')}}
                    </h4>
                </div>
    ...
    <div class="row g-1">
        ...
        <div class="col-md-6 col-xl-4">
            <!-- Card -->
            <div class="card h-100">
                @include('admin-views.partials._top-sellers-fast-delivery',['top_sellers_fast_delivery'=>$data['top_sellers_fast_delivery']])
            </div>
            <!-- End Card -->
        </div>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: ['{{$data['customer']}}', '{{$data['product']}}', '{{$data['order']}}', '{{$data['brand']}}'
                ],
                backgroundColor: [
                    '#041562',
                    '#EEEEEE',
