        ...
        <div class="content container-fluid">
            ...
            <div class="row g-1">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-2 align-items-center">
                                <div class="col-md-6">
                                    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                                        <img src="{{ asset('/assets/back-end/img/earning_statictics.png') }}"
                                            alt="">
                ...
                <div class="col-md-6 col-xl-4">
                    <!-- Card -->
                    <div class="card h-100">
                        @include('admin-views.partials._top-sellers-fast-delivery', [
                            'top_sellers_fast_delivery' => $data['top_sellers_fast_delivery'],
                        ])
                    </div>
                    <!-- End Card -->
                </div>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: ['{{ $data['customer'] }}', '{{ $data['product'] }}', '{{ $data['order'] }}',
                        '{{ $data['brand'] }}'
                    ],
                    backgroundColor: [
                        '#041562',
