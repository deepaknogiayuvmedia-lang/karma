                                    ...
                                    @foreach (json_decode($language) as $lang)
                                        <div class="col-12 form-group {{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                            ...
                                            <label class="title-color"
                                                for="exampleFormControlInput1">{{ \App\CPU\translate('Technical Name') }}
                                                {{ \App\CPU\translate('name') }}<span class="text-danger">*</span>
                                                ({{ strtoupper($lang) }})
                                            </label>
                                            <input type="text" name="name[]" class="form-control"
                                                placeholder="{{ \App\CPU\translate('New_Technical_Name') }}"
                                ...
                                @else
                                    <div class="col-12">
                                        <div class="form-group lang_form" id="{{ $default_lang }}-form">
                                            <label class="title-color">{{ \App\CPU\translate('Technical Name') }}
                                                {{ \App\CPU\translate('name') }}<span class="text-danger">*</span>
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-custom input-group-merge">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                        placeholder="{{ \App\CPU\translate('Search_by_Technical_Name') }}"
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                            toastr.success(
                                '{{ \App\CPU\translate('Technical_Name_Deleted_Successfully') }}.'
                                );
                            location.reload();
                        }
                    });
