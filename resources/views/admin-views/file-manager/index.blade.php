                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                            ...
                            <button class="btn p-0 w-100" data-toggle="modal"
                                ...
                                <div class="gallary-card">
                                    <img src="{{asset(env('PUBLIC_STORAGE_PATH').'/'.str_replace('public/', '', $file['path']))}}"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a class="btn btn--primary"
                                                href="{{route('admin.file-manager.download', base64_encode(asset(env('PUBLIC_STORAGE_PATH').'/'.str_replace('public/', '', $file['path']))))}}"><i
                                                    class="tio-download"></i> {{\App\CPU\translate('download')}}
                                            </a>
                                            <button class="btn btn-info"
                                                onclick="copy_test('{{asset(env('PUBLIC_STORAGE_PATH').'/'.str_replace('public/', '', $file['path']))}}')"><i
