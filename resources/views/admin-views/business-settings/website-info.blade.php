                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{ \App\CPU\translate('OTP') }}
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{ \App\CPU\translate('order') }}
                                    {{ \App\CPU\translate('verification') }}<span class="text-danger">*</span></label>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerWL"
                                    ...
                                    src="{{ asset(config('app.public_storage_path') . '/company') }}/{{ \App\Model\BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0] }}">
                            </center>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerWFL"
                                    onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                    src="{{ asset(config('app.public_storage_path') . '/company') }}/{{ \App\Model\BusinessSetting::where(['type' => 'company_footer_logo'])->pluck('value')[0] }}">
                            </center>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFI"
                                    onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                    src="{{ asset(config('app.public_storage_path') . '/company') }}/{{ \App\Model\BusinessSetting::where(['type' => 'company_fav_icon'])->pluck('value')[0] }}">
                            </center>
                            <div class="position-relative mt-4">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerML"
                                    onerror="this.src='{{ asset('assets/front-end/img/image-place-holder.png') }}'"
                                    src="{{ asset(config('app.public_storage_path') . '/company') }}/{{ \App\Model\BusinessSetting::where(['type' => 'company_mobile_logo'])->pluck('value')[0] }}">
                            </center>
                            <div class="mt-4 position-relative">
