    ...
    <div class="col-md-6">
        <div class="card h-100">
            <div class="card-body">
                ...
                <form
                    action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.payment-method.update', ['phone_pe']) : 'javascript:' }}"
                    method="post">
                    @csrf
                    @if (isset($config))
                        @php($config['environment'] = $config['environment'] ?? 'sandbox')
                        <div class="d-flex flex-wrap gap-2 justify-content-between mb-3">
                            <h5 class="text-uppercase">{{ \App\CPU\translate('phone_pe') }}</h5>
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('assets/back-end/img/phonepe-1.svg') }}" alt="">
                        </center>
                        ...
                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('phone_pe_client_id') }}</label>
                            <input type="text" class="form-control" name="phone_pe_client_id"
                                value="{{ env('APP_MODE') != 'demo' ? $config['phone_pe_client_id'] : '' }}">
                        </div>

                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('phone_pe_secret_key') }}</label>
                            <input type="text" class="form-control" name="phone_pe_secret_key"
                                value="{{ env('APP_MODE') != 'demo' ? $config['phone_pe_secret_key'] : '' }}">
                        </div>

                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('phone_pe_merchant_code') }}</label>
                            <input type="text" class="form-control" name="phone_pe_merchant_code"
                                value="{{ env('APP_MODE') != 'demo' ? $config['phone_pe_merchant_code'] : '' }}">
                        </div>

                        <div class="form-group">
                            <label class="d-flex title-color">{{ \App\CPU\translate('phone_pe_salt_index') }}</label>
                            <input type="text" class="form-control" name="phone_pe_salt_index"
                                value="{{ env('APP_MODE') != 'demo' ? $config['phone_pe_salt_index'] ?? 1 : '' }}">
                        </div>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @if (isset($config))
                        ...
                        <center class="mb-3">
                            <img height="60" src="{{ asset('/assets/back-end/img/senangpay.png') }}" alt="">
                        </center>
