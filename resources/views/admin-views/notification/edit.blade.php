                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="role_type" class="form-control" required>
                                    <option value="customer" {{ $notification->role_type == 'customer' ? 'selected' : '' }}>
                                        {{ \App\CPU\translate('Customer') }}</option>
                                    <option value="seller" {{ $notification->role_type == 'seller' ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="notification_type" class="form-control" required>
                                    <option value="danger"
                                        {{ $notification->notification_type == 'danger' ? 'selected' : '' }}>
                                        {{ \App\CPU\translate('Danger') }}</option>
                                    <option value="warning"
                                        {{ $notification->notification_type == 'warning' ? 'selected' : '' }}>
                                        {{ \App\CPU\translate('Warning') }}</option>
                                    <option value="info"
                                        {{ $notification->notification_type == 'info' ? 'selected' : '' }}>
                                        {{ \App\CPU\translate('Info') }}</option>
                                </select>
                            </div>
