                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle dropdown-toggle-left-arrow"
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="d-none d-md-block media-body text-right">
                                    <h5 class="profile-name mb-0">{{auth('sale_manager')->user()->name}}</h5>
                                    <span class="fz-12"> Admin</span>
                                </div>
                                <div class="avatar border avatar-circle">
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('storage/app/public/admin')}}/{{auth('sale_manager')->user()->photo}}"
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center text-break">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">{{auth('sale_manager')->user()->name}}</span>
                                            <span class="card-text">{{auth('sale_manager')->user()->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    ...
                                    if (result.value) {
                                    location.href='{{route('sale.auth.logout')}}';
                                    } else{
