                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('order_management'))
                            <li class="nav-item {{Request::is('admin/prdouct-query*')?'scroll-here':''}}">
                                <small class="nav-subtitle" title="">{{\App\CPU\translate('Product Query')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <!-- Order -->
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/orders*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:void(0)" title="{{\App\CPU\translate('Product Query')}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/prdouct-query/list')?'active':''}}">
                                        <a class="nav-link" href="{{route('admin.pqlist')}}"
                                           title="{{\App\CPU\translate('All')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{\App\CPU\translate('All')}}
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{\App\Model\ProductQuery::count()}}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/sale/list') || Request::is('admin/sale/add-new') || Request::is('admin/sale/update*'))?'active':''}}">
                        ...
                        <!-- <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/business-settings/chanal') || Request::is('admin/business-settings/web-config/app-settings') || Request::is('admin/product-settings/inhouse-shop') || Request::is('admin/business-settings/seller-settings') || Request::is('admin/customer/customer-settings') || Request::is('admin/refund-section/refund-index') || Request::is('admin/business-settings/shipping-method/setting') || Request::is('admin/business-settings/order-settings/index') || Request::is('admin/product-settings') || Request::is('admin/business-settings/web-config/delivery-restriction') || Request::is('admin/business-settings/cookie-settings'))?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.business-settings.chanal')}}"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/business-settings/chanal')) ?'active':''}}">
