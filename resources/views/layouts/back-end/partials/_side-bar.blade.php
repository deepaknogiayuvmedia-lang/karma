                        ...
                        @if (\App\CPU\Helpers::module_permission_check('order_management'))
                            <li class="nav-item {{ Request::is('admin/prdouct-query*') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                                    title="">{{ \App\CPU\translate('Product Query') }}</small>
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{ Request::is('admin/sellers/seller-score') ? 'active' : '' }}">
                                        <a class="nav-link" title=" Seller Score"
                                            href="{{ route('admin.sellers.seller-score') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                               Seller Score
                                            </span>
