    ...
    <footer class="page-footer font-small mdb-color rtl">
        ...
        <div style="background: #00695c;">
            <div class="container">
                    ...
                    <div class="mb-2 mt-2 max-sm-100 justify-content-center d-flex flex-wrap mt-md-3 mt-0 mb-md-3 {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                    ...
                    <div class="col-md-8" >
                        <div class="row">
                            ...
                            <div class="col-md-4 footer-padding-bottom" >
                                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">My Account</h6>
                            ...
                            <div class="col-md-4 footer-padding-bottom" style="{{Session::get('direction') === "rtl" ? 'padding-right:20px;' : ''}}">
                                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">Information</h6>
                            ...
                            <div class="col-md-4 footer-padding-bottom" style="{{Session::get('direction') === "rtl" ? 'padding-right:20px;' : ''}}">
                                ...
                                @if(auth('customer')->check())
                                    <ul class="widget-list __pb-10px">
                                        ...
                                        @endif
                                        <li class="widget-list-item">
                                            <a class="widget-list-link" href="{{route('account-tickets')}}">{{ \App\CPU\translate('Support Ticket')}}</a>
                                        </li>
                                ...
                                @else
                                    <ul class="widget-list __pb-10px">
                                        ...
                                        <li class="widget-list-item">
                                            <a class="widget-list-link" href="{{route('customer.auth.login')}}">{{ \App\CPU\translate('Support Ticket')}}</a>
                                        </li>
                                    </ul>
                                @endif
                            </div>
...
<hr class="start_address_under_line">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align">
                    <div class="max-sm-100 justify-content-center d-flex flex-wrap mt-md-3 mt-0 mb-md-3 {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                        <div class="mb-2">
                                        <h6 class="text-uppercase mb-1 font-weight-bold footer-heder">{{\App\CPU\translate('NEWS LETTER')}}</h6>
                                        <span>{{\App\CPU\translate('subscribe to our new channel to get latest updates')}}</span>
                                    </div>
                    </div>
        ...
        <hr class="start_address_under_line">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align">
                    ...
                    <div class="">
                        <a class="d-block" href="{{route('home')}}">
                            <img class="{{Session::get('direction') === "rtl" ? 'rightalign' : ''}}" src="{{asset('public/assets/front-end/img/payment.png')}}"
                                onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                alt="{{ $web_config['name']->value }}"/>
                        </a>
                    </div>
