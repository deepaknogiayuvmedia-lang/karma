...
class OrderController extends Controller
{
    ...
    public function addExpressDelivery(Request $request)
    {
        ...
        foreach ($orderIds as $orderId) {
            ...
            // $orderDetails =  [
            //     "clientDetails" => [
            //         "clientName" =>  isset($orders->customer) ? $orders->customer->f_name. ' '.$orders->customer->l_name:'not found',,
            //         "clientId" => $orders->customer_id,
            //     ],
            //     "serviceDetails" => [
            //         "serviceType" => "SD",
            //         "serviceVertical"=> "Ecom",
            //         "serviceName"=> "EcomForward",
            //         "serviceMode"=> "Air"
            //     ],
            //     "shippingDetails" => [
            //         "pickupDetails" => [
            //             "address"=>[
            //                 {
            //                   "name"=> "Herbanix Ayurveda",
            //                   "addressLine"=> "Herbanix Ayurveda 1st floor BSS Tower ,Lohagal Chouraha. Janana Road. Ajmer/",
            //                   "landmark"=> "BSS Tower",
            //                   "city"=> "Ajmer",
            //                   "stateCountry"=> "8",
            //                   "pincode"=> 305004,
            ...
            //               "contactDetails"=> [
            //                 {
            //                   "contactNumberExt"=> 8104525175,
            //                   "contactNumber"=> 8104525175,
            //                   "virtualNumber"=> 0,
            //                   "emailid"=> "info@herbanix.co",
            //                   "type"=> "primary"
            //                 }
            //               ],
            //         ],
            ...
            //                 {
            //                   "name"=> "string",
            //                   "addressLine"=> isset($orders->shippingAddress)? $orders->shippingAddress->address:'not found',
            //                   "landmark"=> isset($orders->shippingAddress)? $orders->shippingAddress->address:'not found',
            //                   "city"=> "string",
            //                   "stateCountry"=> "string",
            //                   "pincode"=> 0,
            //                   "countryType"=> "IN",
            ...
            //         ],
            //         "shipmentDetails" => [
            //             "awbMpsGroupId": "string",
            //             "packageType": "box",
            //             "orderType":  $orders->shipping_type,
            ...
            //                 "orderNumber": "string",
            //                 "awbNumber": "string",
            //                 "customerPromiseDate": "Date format dd-mm-yyyy Date & Time format dd-mm-yyyy HH:mm:ss",
            //                 "manifestId": "string",
            //                 "collectableAmount": {
            //                   "value": 0,
            //                   "unit": "INR"
            ...
            //                   "isOpenDelivery": true,
            //                   "isEssential": true,
            //                   "isSecondaryPacking": true,
            //                   "isCommercialProperty": false,
            //                   "isDGShipmentType": false,
            //                   "senderName": "First Cry"
            //                 },
            //                 "packageDetails": {
            //                   "packageDimension": {
            //                     "length": {
            ...
            //     ],
            // ];
            // $jsonString = json_encode($orderDetails, JSON_PRETTY_PRINT);
            // $response = Http::post('https://stage-global-api.xbees.in/global/v1/serviceRequest', $orderDetails, [
            //     'headers' => [
            ...
            // if ($result) {
            //     $order->delivery_type = 'third_party_delivery';
            //     $order->delivery_service_name = 'Express Bee';
            //     $order->third_party_delivery_tracking_id = $result['data'];
            //     $order->delivery_man_id = null;
            //     $order->deliveryman_charge = 0;
            //     $order->expected_delivery_date = null;
            //     $order->save();
